...
class Rectangle:
    ...
    Methods:
        ...
        bigger_or_equal: Static method that returns the bigger rectangle based on the area.
        square: Class method that returns a new Rectangle instance with width == height == size.
    """
